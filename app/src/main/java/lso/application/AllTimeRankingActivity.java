...
public class AllTimeRankingActivity extends AppCompatActivity {
    ...
    private TextView all_time_ranking_view;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.all_time_ranking_activity);

        return_button = (ImageButton)findViewById(R.id.return_button);
        return_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(AllTimeRankingActivity.this, ChooseRankingActivity.class));
            }
        });

        all_time_ranking_view = (TextView)findViewById(R.id.all_time_ranking_view);
    ...
    private void createRanking(){
        ...
        for (int i = 0; i < altar_boys_list.size(); i++){
            ...
            all_time_ranking_view.append(s);
            all_time_ranking_view.setMovementMethod(new ScrollingMovementMethod());
        }
    }
