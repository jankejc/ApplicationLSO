...
public class PreviousMonthRankingActivity extends AppCompatActivity {
    ...
    private TextView previous_month_ranking_view;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.previous_month_ranking_activity);

        return_button = (ImageButton)findViewById(R.id.return_button);
        return_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PreviousMonthRankingActivity.this, ChooseRankingActivity.class));
            }
        });

        previous_month_ranking_view = (TextView)findViewById(R.id.previous_month_ranking_view);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    AltarBoy temp_boy = new AltarBoy(ds.child("fullname").getValue(String.class),
                            ds.child("previous_month_points").getValue(Integer.class),
                            ds.child("previous_month_points").getValue(Integer.class));
    ...
    private void createRanking(){
        ...
        for (int i = 0; i < altar_boys_list.size(); i++){
            ...
            previous_month_ranking_view.append(s);
            previous_month_ranking_view.setMovementMethod(new ScrollingMovementMethod());
        }
    }
